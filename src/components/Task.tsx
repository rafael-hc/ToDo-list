        ...
        <div className="grid grid-cols-[24px,_1fr,_24px] gap-3 rounded-lg bg-gray-500 p-4 items-start group">
            <div className="flex items-center justify-center check">
                ...
                <button
                    ...
                    className={classNames("w-[1.1rem] h-[1.1rem] rounded-full border-2 cursor-pointer transition-colors", {
                        "bg-purple-dark border-purple-dark bg-checked bg-no-repeat bg-center text-gray-100 hover:bg-purple-base hover:border-purple-base": isComplete,
                        "hover:bg-blue-dark border-blue-base hover:bg-opacity-20 hover:border-blue-dark": !isComplete,
                    })}
                >
                </button>
            </div>
            <div className={classNames("flex items-center justify-start text-sm leading-5", {
